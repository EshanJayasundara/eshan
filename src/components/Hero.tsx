    ...
    <section className="relative flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-24 mb-24 text-center md:text-left">
      ...
      >
        <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight text-foreground">
          Hi, I'm <br />
          <span className="text-gradient">Eshan Jayasundara</span>
        </h1>
        ...
        <p className="text-lg text-slate-600 dark:text-slate-300 max-w-2xl mb-12 leading-relaxed">
          Specializing in <strong>Classical Machine Learning</strong>,{" "}
          <strong>Natural Language Processing</strong>,{" "}
          <strong>Large Language Models</strong> and <strong>AI Agents</strong>,
          with hands-on experience building and deploying production-grade ML
          pipelines. Focused on delivering scalable and reliable AI solutions.
        </p>

        <div className="flex flex-wrap justify-center md:justify-start gap-4 mb-8 w-full">
          <a
            href="https://github.com/EshanJayasundara"
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-0 hover:gap-3 p-4 glass rounded-2xl hover:scale-105 hover:text-primary transition-all duration-300 ease-in-out"
          >
          ...
          <a
            href="https://linkedin.com/in/eshan-jayasundara"
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-0 hover:gap-3 p-4 glass rounded-2xl hover:scale-105 hover:text-primary transition-all duration-300 ease-in-out"
          >
          ...
          <a
            href="mailto:jayasundara.jmeg@gmail.com"
            className="group flex items-center gap-0 hover:gap-3 p-4 glass rounded-2xl hover:scale-105 hover:text-primary transition-all duration-300 ease-in-out"
          >
          ...
          <a
            href={`${BASE_PATH}/cv/EshanJayasundara_cv_latest.pdf`}
            download
